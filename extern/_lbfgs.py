"""Copied from JAX 0.3.14 source for ease of modification:
_src/scipy/optimize/_lbfgs.py"""
...
def _minimize_lbfgs(
    ...
    maxls: int = 20,
    # CHANGE: Allow an initial_state to be passed
    state_initial=None
):
  """
  ...
  # CHANGE: only evaluate an initial state if one wasn't provided
  if state_initial is None:
    ...
    # CHANGE:
    # Reset certain crucial state elements so training can continue
